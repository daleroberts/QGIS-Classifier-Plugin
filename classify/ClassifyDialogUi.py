...
class Ui_ClassifyDialog(object):
    def setupUi(self, ClassifyDialog):
        ...
        self.uLinesClassifys = QtWidgets.QRadioButton(self.groupBox)
        self.uLinesClassifys.setObjectName("uLinesClassifys")
        self.horizontalLayout_7.addWidget(self.uLinesClassifys)
        self.uFilledClassifys = QtWidgets.QRadioButton(self.groupBox)
        self.uFilledClassifys.setObjectName("uFilledClassifys")
        self.horizontalLayout_7.addWidget(self.uFilledClassifys)
        ...
        self.gridLayout_2.addWidget(self.uClassifyInterval, 2, 1, 1, 1)
        ...
        self.uHelpButton = QtWidgets.QPushButton(ClassifyDialog)
        ...
        ClassifyDialog.setTabOrder(self.uSourceLayer, self.uLinesClassifys)
        ClassifyDialog.setTabOrder(self.uLinesClassifys, self.uFilledClassifys)
        ClassifyDialog.setTabOrder(self.uFilledClassifys, self.uBoth)
        ...
        ClassifyDialog.setTabOrder(self.uExtend, self.uLevelsList)
        ClassifyDialog.setTabOrder(self.uLevelsList, self.uOutputName)
    ...
    def retranslateUi(self, ClassifyDialog):
        ...
        self.uLinesClassifys.setText(_translate("ClassifyDialog", "Classify lines"))
        self.uFilledClassifys.setText(_translate("ClassifyDialog", "filled Classifys"))
        ...
        self.uHelpButton.setText(_translate("ClassifyDialog", "Help"))
